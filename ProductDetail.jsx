...
function ProductDetail() {
  ...
  return productData ? (
    <div>
        <div className='w-[100vw] h-[200vh] md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start flex-col lg:flex-row gap-[20px]'>
           <div className='lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
                <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-[20px] lg:flex-col flex-wrap'>
            ...
            flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px'>
                ...
                <p className='text-[18px] font-semibold pl-[5px] text-[white]'>(245)</p>

                </div>
                <p className='text-[30px] font-semibold pl-[5px] text-white'>{currency}{productData.price}</p>
                <p className='w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-white'>{productData.description}. Designed for comfort and made to last, this piece blends quality craftsmanship with everyday style. Crafted from premium materials, it offers a perfect fit and versatile look — ideal for any occasion, season, or wardrobe. Whether you're dressing up or keeping it casual, this essential adds effortless style to your day.</p>
                ...
                <div className='flex flex-col gap-[10px] my-[10px]'>
                    ...
                    <div className='flex gap-2'>
                        {
                            productData.sizes.map((item, index)=>(
                                ...
                                ${item === sizes ? 'bg-black text-[#2f97f1] text-[20px]' : ''}`}
                    ...
                    cursor-pointer bg-[#495b61c9] py-[10px] px-[20px] rounded-2xl mt-[10px] border-[1px] border-[#80808049]
                    text-white shadow-md shadow-black' onClick={()=>addtocart(productData._id,sizes)}>Add To Cart</button>
                    </div>
            ...
            lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
                <p className='w-[95%] h-[90%] flex items-center justify-center'>
                    Upgrade your wardrobe with this stylish and comfortable piece, designed to offer both everyday versatility and timeless appeal. Crafted from high-quality fabric, this garment provides a perfect balance of durability, breathability, and comfort. Whether you're dressing up for a special occasion or keeping it casual, this piece adapts effortlessly to your style.
                </p>
