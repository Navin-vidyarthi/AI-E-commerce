...
export const registration = async (req,res) => {
    try {
        ...
        if(password.length < 8){
            return res.status(400).json({massage:"Enter Strong Password"})
        }
...
export const login = async (req,res) => {
    try {
        ...
        return res.status(201).json({massage:"login successful"})
    }catch (error){
...
export const logOut = async (req,res) =>{
    try {
        ...
        return res.status(200).json({massage:"logOut successfull"})
    }catch (error){
