...
function Orders() {
    ...
    const fetchAllOrders = async ()=>{
        try {
            ...
            console.log(error)
            toast.success("Failed to fetch the Order")
  ...
  return (
    <div className='w-[100vw] h-[100vw] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] relative'>
        <Nav/>
        <div className='w-[100%] h-[100%] flex items-center lg:justify-start justify-center'>
            <Sidebar/>
            <div className='lg:w-[100%] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[70px] flex flex-col gap-[30px] overflow-X-hidden py-[50px] ml-[100px]'>
