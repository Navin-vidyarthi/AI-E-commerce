...
function Hero({heroData, heroCount, setHeroCount}) {
  return (
    <div className='w-[40%] h-[100%] relative'>
        ...
        md:left-[10%] md:top-[90px] 1g:top-[130px] left-[10%] top-[10px]'>
            <p>{heroData.text1}</p>
            <p>{heroData.text2}</p>
        </div>
        <div className='absolute md:top-[400px] 1g:top-[500px]
           top-[160px] left-[10%] flex items-center justify-center gap-[10px] '>
