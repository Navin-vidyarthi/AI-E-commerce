...
function Order() {
    ...
    let {currency,delivery_fee}=useContext(shopDataContext)
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] p-[20px] pb-[150px] overflow-hidden bg-gradient-to-l from-[#0f0f0f] to-[#1b2c3b]
  '>
        <div className='h-[80%] w-[100%] text-center mt-[80px]'>
            <Tital text1={'YOUR'} text2={'ORDER'}/>
                    ...
                    <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                        <img src={item.image1} alt="" className='w-[130px] h-[130px] rounded-md'/>
                         <div className='flex items-start justify-center flex-col gap-[5px]'>
                            ...
                            <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>{currency} {delivery_fee + item.price * item.quantity}</p>
                        ...
                        <div className='absolute md:right-[5%] right-[1%] md:top-[40%] top-[70%]'>
                            <button className='md:px-[15px] px-[5px] py-[3px] md:py-[7px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500' onClick={loadOrderData}>Track Order
